export function generateOtpTemplate(name: string, otp: string): string {
  return `
    ...
    <head>
      ...
      <title>Your OTP - Ticketer Africa</title>
    </head>
    <body style="margin: 0; padding: 0; background-color: #f5f5f5; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, Arial, sans-serif; line-height: 1.6;">
      ...
      <div style="display: none; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: transparent;">
        Your Ticketer Africa OTP is ${otp}. Use it to verify your account.
      </div>
                ...
                <td style="padding: 40px;">
                  ...
                  <div style="text-align: center; margin-bottom: 32px;">
                    ...
                    <p style="font-size: 16px; color: #666666; margin: 0; font-weight: 400;">
                      Use this code to verify your <strong>Ticketer Africa</strong> account.
                    </p>
                  </div>
